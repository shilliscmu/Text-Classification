...
EMB_SIZE = 64
w_emb = model.add_lookup_parameters((nwords, 1, 1, EMB_SIZE), init='glorot')
WIN_SIZE = 3
FILTER_SIZE = 64

w_cnn = model.add_parameters((1, WIN_SIZE, EMB_SIZE, FILTER_SIZE), init='glorot')
b_cnn = model.add_parameters((FILTER_SIZE))

w_sm = model.add_parameters((ntags, FILTER_SIZE), init='glorot')
